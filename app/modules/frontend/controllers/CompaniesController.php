...
use Multiple\Models\Companies;
use Multiple\Forms\CompaniesForm;

class CompaniesController extends FrontendControllerBase
{
    ...
    public function searchAction()
    {
        ...
        if ($this->request->isPost()) {
            $query = Criteria::fromInput($this->di, "Multiple\\Models\\Companies", $this->request->getPost());
