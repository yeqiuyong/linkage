...
<script type="text/javascript">
    ...
    initDatePlugin();
    loadOrderCountByMon();
    loadManufacureOrderTable('loadManufacureOrderTable',pageindexinit, '厂商订单数','厂商出口订单数', 'manufacture-order-table');
    loadTransporterOrderTable('loadManufacureOrderTable',pageindexinit, '承运商订单数','承运商出口订单数', 'transporter-order-table');
