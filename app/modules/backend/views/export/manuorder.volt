            ...
            <div class="box col-md-10" >
                ...
                {{ form('admin/export/find', 'role': 'form', 'enctype':'multipart/form-data') }}
                    ...
                    <div class="col-md-2" style="padding-left:40px;padding-top:25px;">
                        ...
                        <input type="hidden" value="<?php echo $id;?>" id="manu_id">
                    </div>
                </form>
            </div>
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane active" id="manufacture">
                <div class="box col-md-12" >
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="订单信息">
                            <h2><i class="glyphicon glyphicon-list-alt"></i> 订单列表</h2>
                            <div class="box-icon">
...
<script type="text/javascript">
    ...
    function loadManufactures(pageindex) {
        ...
        $('#export').attr('href','createManuOrder?id='+id+'&start_time='+start_time+'&end_time='+end_time);

        $.ajax({
            type: "post",
            dataType:"json",
            url: "<?php echo $this->url->get('admin/export/manuOrderList') ?>",
    ...
    function render(func, mydiv,  pageindex, page){
        ...
        strtable += '<thead><tr> <th>编号</th>  <th>订单号</th> <th>订单类型</th> <th>接单公司</th> <th>下单时间</th> <th>订单状态</th> </tr> </thead>';
